...
import com.example.lawnotes10v.data.criminal.actus_reus.CriminalActusReusQuizQuestion
import com.example.lawnotes10v.data.criminal.actus_reus.QuizRepository.quizQuestions
...
class CriminalQuizChapter1Activity : AppCompatActivity() {
    ...
    private fun loadQuestion(question: CriminalActusReusQuizQuestion) {
