...
import com.example.lawnotes10v.data.criminal.mensrea.CriminalMensReaQuizQuestion
import com.example.lawnotes10v.data.criminal.mensrea.QuizRepository
import com.example.lawnotes10v.databinding.ActivityCriminalQuizChapter4Binding


class CriminalQuizChapter4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityCriminalQuizChapter4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCriminalQuizChapter4Binding.inflate(layoutInflater)
    ...
    private fun loadQuestion(question: CriminalMensReaQuizQuestion) {
    ...
    private fun navigateToScoreScreen() {
        val intent = Intent(this, CriminalQuizScoreChapter4Activity::class.java)
