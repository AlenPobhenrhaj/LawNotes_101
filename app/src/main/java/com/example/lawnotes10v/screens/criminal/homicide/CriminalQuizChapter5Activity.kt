...
import com.example.lawnotes10v.data.criminal.homicide.CriminalHomicideQuizQuestion
import com.example.lawnotes10v.data.criminal.homicide.QuizRepository
import com.example.lawnotes10v.databinding.ActivityCriminalQuizChapter5Binding


class CriminalQuizChapter5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityCriminalQuizChapter5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCriminalQuizChapter5Binding.inflate(layoutInflater)
    ...
    private fun loadQuestion(question: CriminalHomicideQuizQuestion) {
    ...
    private fun navigateToScoreScreen() {
        val intent = Intent(this, CriminalQuizScoreChapter5Activity::class.java)
