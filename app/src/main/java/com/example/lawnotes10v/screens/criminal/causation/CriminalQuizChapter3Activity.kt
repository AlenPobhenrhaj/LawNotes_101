...
import com.example.lawnotes10v.data.criminal.causation.CriminalCausationQuizQuestion
import com.example.lawnotes10v.data.criminal.causation.QuizRepository
import com.example.lawnotes10v.databinding.ActivityCriminalQuizChapter3Binding

class CriminalQuizChapter3Activity : AppCompatActivity() {
    private lateinit var binding: ActivityCriminalQuizChapter3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCriminalQuizChapter3Binding.inflate(layoutInflater)
    ...
    private fun loadQuestion(question: CriminalCausationQuizQuestion) {
    ...
    private fun navigateToScoreScreen() {
        val intent = Intent(this, CriminalQuizScoreChapter3Activity::class.java)
